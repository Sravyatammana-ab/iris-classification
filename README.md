...
First of all download all the files in a folder, and then in any environment open the folder that you added the files. Run the file named model.py and then it will take to you the browser.
